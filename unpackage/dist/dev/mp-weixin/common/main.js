...
/***/ 0:
/*!*************************************************************************!*\
  !*** E:/m_study/important data/CloCoder/Code/Zhanbu/taluo-main/main.js ***!
  \*************************************************************************/
...
_vue.default.prototype.adUtils = _ad.default;
...
_vue.default.prototype.imgUrl = api_host;

// 统一请求函数
_vue.default.prototype.http = function (path, data) {
  var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'post';
  var showLoading = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  return _utils.default.http(this, path, data, method, showLoading);
};

// 获取当前页面路径
_vue.default.prototype.currentPage = function () {
  var pages = getCurrentPages(); // 获取栈实例
  var currentRoute = pages[pages.length - 1].route; // 获取当前页面路由
  var currentPage = pages[pages.length - 1]['$page']['fullPath']; //当前页面路径(带参数)
  return currentPage;
};

// 正常格式的日期时间
_vue.default.filter('format_date', function (time) {
  ...
  return "".concat(YY, "-").concat(MM, "-").concat(D, " ").concat(hh, ":").concat(mm);
});

// 秒转时分秒格式
_vue.default.filter('format_second', function (second) {
  var tips = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '不限时';
  ...
  var res = '';
  if (h !== '00') res += "".concat(h, "\u65F6");
  if (m !== '00') res += "".concat(m, "\u5206");
  res += "".concat(s, "\u79D2");
  return res;
});
...
/***/ 27:
/*!*************************************************************************!*\
  !*** E:/m_study/important data/CloCoder/Code/Zhanbu/taluo-main/App.vue ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ 28:
/*!**************************************************************************************************!*\
  !*** E:/m_study/important data/CloCoder/Code/Zhanbu/taluo-main/App.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 30:
/*!***********************************************************************************************************!*\
  !*** E:/m_study/important data/CloCoder/Code/Zhanbu/taluo-main/App.vue?vue&type=style&index=0&lang=scss& ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
