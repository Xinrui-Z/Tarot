...
/***/ 73:
/*!**********************************************************************************************************!*\
  !*** E:/m_study/important data/CloCoder/Code/Zhanbu/taluo-main/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \**********************************************************************************************************/
...
/***/ 74:
/*!***************************************************************************************!*\
  !*** E:/m_study/important data/CloCoder/Code/Zhanbu/taluo-main/pages/index/index.vue ***!
  \***************************************************************************************/
/*! no static exports found */
...
/***/ 75:
/*!**********************************************************************************************************************!*\
  !*** E:/m_study/important data/CloCoder/Code/Zhanbu/taluo-main/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \**********************************************************************************************************************/
...
/***/ 77:
/*!****************************************************************************************************************!*\
  !*** E:/m_study/important data/CloCoder/Code/Zhanbu/taluo-main/pages/index/index.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default = {
  ...
  methods: {
    ...
    wxlogin: function wxlogin() {
      ...
      uni.login({
        ...
        success: function success(res) {
          ...
          _this.http('/user/wxLogin', data, 'post').then(function (res) {
            console.log(JSON.stringify(res));
            if (res.code === 200) {
              _this.userinfo = res.data;
              var result = _this.save_login(res.data);
              if (result) {
                // return uni.navigateTo({
                // 	url: '/pages/index/load'
                // })
    ...
    save_wxlogin: function save_wxlogin(data) {
    ...
    logindy: function logindy() {
      var this_ = this;
      var data = {
        'code': this_.code,
        'anonymousCode': this_.anonymousCode,
        'nick': this_.nickName,
        'avatar': this_.avatarUrl
      };
      this.http('/tarot/dylogin', data, 'get').then(function (res) {
        // console.log(JSON.stringify(res))
        if (res.code === 1) {
          // console.log(res.data)
          // this_.openid = res.data.data.openid
          // this_.unionid = res.data.data.unionid
          var result = this_.save_login(res.data);
          if (result) {
            return uni.navigateTo({
              url: '/pages/index/load'
            });
    ...
    save_login: function save_login(data) {
      var userinfo = {
        id: data.id,
    ...
    getOrderByUser: function getOrderByUser() {
      this.http('/tarot/getOrderByUser', {
...
/***/ 79:
/*!************************************************************************************************************************!*\
  !*** E:/m_study/important data/CloCoder/Code/Zhanbu/taluo-main/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
